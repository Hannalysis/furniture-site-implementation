...
const products: ProductCardData[]  = [
  { id: 1, title: "Syltherine", image: imgProduct1, desc: "Stylish cafe table", price: "Rp 2.500.000", wasPrice: "Rp 3.500.000", sticker: {type: "sale", label: "-30%"}},
  { id: 2, title: "Levisoa", image: imgProduct2, desc: "Stylish cafe chair", price: "Rp 2.500.000"},
  { id: 3, title: "Lilito", image: imgProduct3, desc: "Luxury big sofa", price: "Rp 7.000.000", wasPrice: "Rp 14.000.000", sticker: {type: "sale", label: "-50%"}},
  { id: 4, title: "Respira", image: imgProduct4, desc: "Outdoor bar table and stool", price: "Rp 500.000", sticker: {type: "new", label: "New"}},
  { id: 5, title: "Grifo", image: imgProduct5, desc: "Night lamp", price: "Rp 1.500.000"},
  { id: 6, title: "Muggo", image: imgProduct6, desc: "Small mug", price: "Rp 150.000", sticker: {type: "new", label: "New"}},
  { id: 7, title: "Pingky", image: imgProduct7, desc: "Cute bed set", price: "Rp 7.000.000", wasPrice: "Rp 14.000.000", sticker: {type: "sale", label: "-50%"}},
  { id: 8, title: "Potty", image: imgProduct8, desc: "Minimalist flower pot", price: "Rp 500.000", sticker: {type: "new", label: "New"}},
]
